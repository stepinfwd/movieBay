...
function MovieDetailCard({ movieitem }) {
  const fall_src =
    "https://images.unsplash.com/photo-1555952517-2e8e729e0b44?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxzZWFyY2h8MjN8fHBlcnNvbnxlbnwwfHwwfA%3D%3D&auto=format&fit=crop&w=500&q=60;";
              ...
              <div className="movie_header">
                {movieitem.image && (
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${
                        movieitem.image.original || fall_src
                      }) `,
                    }}
                    alt=""
                  />
