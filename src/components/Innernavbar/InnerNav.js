      ...
      <Router>
        <div className="inner_nav">
          <ul className="breadcrumb">
            <li >
              <Link onClick={()=>secondLevelMenuToggle('detailOn')} className={detailOn?'active':"non-active"} to={`${url}/`}>Details</Link>
            </li>
            <li>
              <Link onClick={()=>secondLevelMenuToggle('castOn')}  className={castOn?'active':"non-active"} to={`${url}/cast`}>Cast</Link>
            </li>
            {/* <span>|</span> */}

            <li>
              <Link onClick={()=>secondLevelMenuToggle('crewOn')}  className={crewOn?'active':"non-active"} to={`${url}/crew`}>Crew</Link>
            </li>
            {/* <span>|</span> */}
            <li>
              <Link onClick={()=>secondLevelMenuToggle('galleryOn')}  className={galleryOn?'active':"non-active"} to={`${url}/gallery`}>Gallery</Link>
            </li>
            {/* <span>|</span> */}

            <li>
              <Link onClick={()=>secondLevelMenuToggle('episodeOn')}  className={episodeOn?'active':"non-active"} to={`${url}/episode`}>Episode</Link>
            </li>
          </ul>
